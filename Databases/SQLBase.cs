...
namespace Pflegehaushaltsbuch.Databases
{
    ...
    public abstract class SQLBase : IDisposable
    {
        ...
        /// </summary>
        public delegate void OnUserRights(int access, bool admin, bool supervisor);
        public event OnUserRights UserRights;
        /// <summary>
        ...
        {
            { SELECT.Barge, "SELECT * FROM barge"},
            { SELECT.BargeFromMonth, "SELECT * FROM barge WHERE MONTH(date)='{0}' AND YEAR(date)='{1}'" },
            { SELECT.BargeByPeriod,  "SELECT * FROM barge WHERE (date) >= {0} AND (date) < {1}" },
            ...
            { SELECT.Bank, "SELECT * FROM bank"},
            { SELECT.BankByPeriod, "SELECT * FROM bank WHERE (date) >= {0} AND (date) < {1}" },
            { SELECT.BankByDate, "SELECT * FROM bank WHERE MONTH(date)='{0}' AND YEAR(date)='{1}'" },
            { SELECT.Assistants, "SELECT * FROM assistants"},
            { SELECT.Assistant, "SELECT * FROM assistants WHERE id='{0}'"},
            { SELECT.Book, "SELECT * FROM books WHERE id='{0}' AND MONTH(date)='{1}' AND YEAR(date)='{2}'"},
            { SELECT.BooksByPeriod, "SELECT * FROM books WHERE id='{0}' AND (date) >= {1} AND (date) < {2}" },
            { SELECT.Books, "SELECT * FROM books"},
            { SELECT.BooksByUser, "SELECT * FROM books WHERE id='{0}'"},
        ...
        public async Task<bool> UpdateAsistanceAsync(string name, DateTime date, decimal amount, int repayment)
        {
            ...
            await FillAdapterAsync(SELECT.Assistants, table);
            ...
            return await UpdateAdapterAsync(SELECT.Assistants, table);
        }
        /// <summary>
        ...
        public async Task<bool> ToBargeAsync(DateTime date, string note, decimal amount, string account, BookCategory bookingCategory, BookingTo bookTo)
        {
            ...
            await FillAdapterAsync(SELECT.Barge, cashTable);
            ...
            return await UpdateAdapterAsync(SELECT.Barge, cashTable);
        }
        /// <summary>
        ...
        public async Task BackupAsync(string filename)
        {
            ...
            await FillAdapterAsync(SELECT.Barge, table, "");
            dataset.Tables.Add(table);
        ...
        public virtual async Task RestoreAsync(string filename)
        {
            ...
            table = new DataTable();
            await FillAdapterAsync(SQLBase.SELECT.Barge, table, "");
            await TransferDataAsync(SELECT.Barge, dataset.Tables["Barge"], table);
            ...
            table = new DataTable();
            await FillAdapterAsync(SQLBase.SELECT.Assistants, table, "");
            await TransferDataAsync(SELECT.Assistants, dataset.Tables["Assistants"], table);
