...
namespace Pflegehaushaltsbuch.Forms
{
    ...
    /// </summary>
    public partial class BookForm : Form, IBookFormContract
    {
        ...
        /// </summary>
        public BookForm(SqlSession session)
        {
            InitializeComponent();
            Session = session;
            presenter = new BookFormPresenter(this, session);
        ...
        public override void ApplyUserRights(UserRights rights)
        {
            ...
            commentBox.Enabled = stornoButton.Enabled = rights.CanModify;
        }
        ...
        /// </summary>
        string IBookFormContract.DefaultSortColumn
        {
        ...
        /// </summary>
        string IBookFormContract.NumberColumnName
        {
        ...
        /// </summary>
        string IBookFormContract.DateColumnName
        {
            get { return dateColumn.DataPropertyName; }
        }
        ...
        /// </summary>
        string IBookFormContract.BookCategoryColumnName
        {
        ...
        /// </summary>
        string IBookFormContract.AmountColumnName
        {
        ...
        /// </summary>
        DateTime IBookFormContract.FromDate
        {
        ...
        /// </summary>
        DateTime IBookFormContract.ToDate
        {
        ...
        /// </summary>
        bool IBookFormContract.PeriodChecked
        {
        ...
        /// </summary>
        void IBookFormContract.ShowPrintBooksDialog(System.Data.DataTable table, int clientID, string totalAmount, DateTime from, DateTime to)
        {
        ...
        /// </summary>
        bool IBookFormContract.ShowClientBookDialog(string clientName, string clientID, out ClientBookingInput input)
        {
        ...
        /// </summary>
        void IBookFormContract.SetPeriodControlsVisible(bool visible)
        {
        ...
        /// </summary>
        void IBookFormContract.ShowClientsForm()
        {
