...
{
    public class BankBookDialogPresenter
    {
        private readonly IBankBookDialogContract view;
        ...
        public BankBookDialogPresenter(IBankBookDialogContract view, SqlSession session)
        {
            if (view == null)
            {
        ...
        public virtual void ValidateOk()
        {
            try
            {
                ...
                if (view.BookingTarget == SQLBase.BookingTo.Bankbestand && !view.SelectedClients.Any())
