...
namespace Pflegehaushaltsbuch.Forms.Dialoge
{
    ...
    /// </summary>
    public partial class BankBookDialog : Pflegehaushaltsbuch.FormControls.Form
    {
        ...
        /// <summary>
        /// Creates a new Bank Book Form instance and initializes the required state.
        /// </summary>
        public BankBookDialog(SQLBase sql)
        {
            InitializeComponent();
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (BookingTarget == SQLBase.BookingTo.Bankbestand && !SelectedClients.Any())
